...
public class WindowBuilder extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        MovimentarEstoqueButton.setFont(Font.loadFont(getClass().getResourceAsStream("/resources/fonts/Lexend.ttf"), 14.00));
        ...
        InventarioButton.setFont(Font.loadFont(getClass().getResourceAsStream("/resources/fonts/Lexend.ttf"), 14.00));
        ...
        RelatorioButton.setFont(Font.loadFont(getClass().getResourceAsStream("/resources/fonts/Lexend.ttf"), 14.00));
        ...
        CardapiosButton.setFont(Font.loadFont(getClass().getResourceAsStream("/resources/fonts/Lexend.ttf"), 14.00));
        ...
        AreaTexto.setFont(Font.loadFont(getClass().getResourceAsStream("/resources/fonts/Lexend.ttf"), 14.00));
        ...
        Label element7 = new Label("Olá, ");
        element7.setLayoutX(57.4375);
        element7.setLayoutY(15.796875);
        element7.setPrefWidth(105.8125);
        element7.setPrefHeight(18);
        element7.setFont(Font.loadFont(getClass().getResourceAsStream("/resources/fonts/Lexend.ttf"), 14.00));
