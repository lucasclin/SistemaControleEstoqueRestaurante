...
/**
 * Tela somente-leitura do cardápio, no mesmo padrão das demais telas
 * (construtor + start(Stage), montada na mão, usando os Ctrl existentes).
 *
 * O cardápio do dia é uma lista única: junta, sem distinção visual, as
 * receitas do dia da semana selecionado com as FIXO, FESTIVO e TMP.
 */
public class CardapioView {
    ...
    public void start(Stage primaryStage) {
        ...
        // Recarrega a listagem ao trocar o dia.
    ...
    /**
     * Uma receita entra no cardápio do dia se for do próprio dia da semana
     * selecionado ou de um marcador que aparece todo dia (FIXO, FESTIVO, TMP).
     */
