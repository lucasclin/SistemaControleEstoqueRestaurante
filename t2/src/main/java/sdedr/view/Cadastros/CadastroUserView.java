...
public class CadastroUserView extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        CadastrarUserTXT.setFont(Font.loadFont(getClass().getResourceAsStream("/fonts/BlexMonoNerdFont-Regular.ttf"), 14.00));
        ...
        senha.setFont(Font.loadFont(getClass().getResourceAsStream("/fonts/Lato.ttf"), 14.00));
